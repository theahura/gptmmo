provider "aws" {
  ...
  # Because we use localstack to emulate AWS locally, we need to change the
  # endpoint for every AWS service to localstack's endpoint rather than
  # production AWS servers.
  endpoints {
