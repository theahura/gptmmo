...
const dtsBundle = {
  ...
  // For some reason `net` is unique in our dependencies in that it HAS to be
  // marked as external even in the `d.ts` bundle otherwise we see "Unresolved
  // dependencies" errors. Why? I have no idea. We typically do not need to
  // declare externals for the `d.ts` bundle.
  external: EXTERNAL,
